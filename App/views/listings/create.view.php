...
<section class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-600 mx-6">
        ...
        <form method="POST" action="/listings">
            ...
            <?php endif; ?>
            <div class="mb-4">
                <input type="text" name="title" placeholder="Job Title (required)" class="w-full px-4 py-2 border rounded focus:outline-none" />
            </div>
            <div class="mb-4">
                <textarea name="description" placeholder="Job Description (required)" class="w-full px-4 py-2 border rounded focus:outline-none"></textarea>
            </div>
            <div class="mb-4">
                <input type="text" name="salary" placeholder="Monthly Salary (required)" class="w-full px-4 py-2 border rounded focus:outline-none" />
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <input type="text" name="city" placeholder="City (required)" class="w-full px-4 py-2 border rounded focus:outline-none" />
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <input type="email" name="email" placeholder="Email Address For Applications (required)" class="w-full px-4 py-2 border rounded focus:outline-none" />
            </div>
